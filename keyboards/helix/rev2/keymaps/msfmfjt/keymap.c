...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | RGUI | LALT | LARG |  DEL | Space|  BS  | Enter| Raise|  BS  | Left | Down |  Up  | Right|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT_kc( \
      ...
      LCTL,   LGUI, LALT, LALG, DEL,  LOWER,SPC,   RAEN,RAISE,BSPC,LEFT, DOWN,   UP, RIGHT \
      ),
   ...
   */
  [_ADJUST] =  LAYOUT( \
      XXXXXXX, KEYPAD,  _______, _______, _______,  QWERTY,          QWERTY,  _______, _______, _______,  KEYPAD, XXXXXXX, \
